...
public class Agenda
{
    ...
    private static double tempoDeFuncionamentoSemana[] = {16.0, 16.0, 16.0, 16.0, 16.0, 16.0, 16.0};
    ...
    */
    ...
    {
        public DiaReservavel(LocalDateTime tempo, Aparelho aparelho){
            super();
            ano = tempo.getYear();
    ...
    public class IntervaloReservavel extends IntervaloDeUso {
