...
public class CalendarioController {
    ...
    @FXML
    private Label valorTotalLabel; // dessa tela em especifico, so falta implementar um recurso para aparecer/atualizar o custo relativo a maquina selecionada para a reserva.
    @FXML
