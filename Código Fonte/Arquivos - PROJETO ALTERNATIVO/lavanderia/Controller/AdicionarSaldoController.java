...
public class AdicionarSaldoController {
    ...
    private void popularComboBox() {
        ...
        List<String> listaMetodos = metodoDePagamento.getMetodoDePagamento();
        ObservableList listaMetodosObservavel = FXCollections.observableArrayList(listaMetodos);
        metodoPagamentoComboBox.setItems(listaMetodosObservavel);
    }
