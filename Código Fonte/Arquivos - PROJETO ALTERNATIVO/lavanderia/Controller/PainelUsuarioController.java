    ...
    private void popularDadosNaTela() {
        if (matriculaUsuarioLogado != 0) {
            ...
            try {
                ...
                emailDisplay.setText("emailpessoaexemplo@gmail.com"); //ainda nao implementamos esse atributo ao cadastro do usuario, por isso colocamos esse campo fixo apenas para exemplo
