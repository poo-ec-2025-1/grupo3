...
public class CrudTest {
    ...
    public static void testAllCrudOperations(String databaseName) {
        ...
        IntervaloDeUsoRepository intervaloRepo = new IntervaloDeUsoRepository(database);
        DiaDaReservaRepository diaRepo = new DiaDaReservaRepository(database);
    ...
    private static void testIntervaloRepository(IntervaloDeUsoRepository repo, 
    ...
    private static void testDiaRepository(DiaDaReservaRepository repo, 
                                        AparelhoRepository aparelhoRepo) {
        Aparelho aparelhoCriado = null;
    ...
    private static void testReservaRepository(ReservaRepository repo, UsuarioRepository usuarioRepo,
                                            IntervaloDeUsoRepository intervaloRepo, DiaDaReservaRepository diaRepo,
                                            AparelhoRepository aparelhoRepo) {
